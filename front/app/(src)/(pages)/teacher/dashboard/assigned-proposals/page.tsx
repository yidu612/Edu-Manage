...
const mockProposals = [
  {
    ...
    abstract:
      'An AI system to predict and improve student academic performance.',
  },
  {
    id: '2',
    ...
    department: 'Computer Science',
    abstract:
      'Secure and tamper-proof academic certificate verification system.',
  },
  {
    id: '3',
          ...
          <div className="flex gap-2">
            <Select defaultValue="all">
              ...
              <SelectContent>
                ...
                <SelectItem value="revision_submitted">
                  Revision Submitted
                </SelectItem>
        ...
        <div className="grid grid-cols-1 gap-4">
          {mockProposals.map((proposal) => {
            ...
            return (
              <Card
                key={proposal.id}
                className="hover:shadow-md transition-all hover:border-primary/20 group"
              >
                  ...
                  <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2 flex-wrap">
                        <Badge
                          variant="outline"
                          className={`${status.colorClass} border gap-1`}
                        >
                    ...
                    <div className="flex -space-x-2 shrink-0">
                      {proposal.students.slice(0, 3).map((student, i) => (
                        <Avatar
                          key={i}
                          className="h-8 w-8 border-2 border-background ring-1 ring-gray-100"
                        >
