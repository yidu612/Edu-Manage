...
export default function CoordinatorSettingsPage() {
  ...
  const avatarInitials = (profile?.fullName ?? profile?.name ?? 'C')
      ...
      <div className="space-y-6 animate-in fade-in duration-500">
        ...
        <Card className="border-none shadow-sm">
          <CardHeader>
            ...
            <CardDescription>Your personal and department details.</CardDescription>
          </CardHeader>
            ...
            <div className="flex items-center gap-6">
              <div className="relative">
                <Avatar className="h-20 w-20 border-4 border-background shadow-lg">
                  ...
                  <AvatarFallback className="text-2xl bg-orange-100 text-orange-700">{avatarInitials}</AvatarFallback>
                </Avatar>
              ...
              <div>
                ...
                <div className="flex gap-2 mt-2 flex-wrap">
                  ...
                  <Badge variant="outline" className="bg-orange-50 text-orange-700 border-orange-200">Coordinator</Badge>
                </div>
              </div>
            </div>
